Scheme
{
	...
	Colors
	{
		...
		"G_Highlight"			"16 5 66 255" // Highlight color
		"G_White"				"255 255 255 255"
		"G_Black"				"0 0 0 255"
		"G_Red"					"230 0 0 255"
		"G_Shadow"				"86 29 97 230" // Shadow color
		...
		"G_Footer"					"31 6 40 255" // Menu footer color
		"G_DimmFooter"				"28 23 19 200" // Dimm Menu footer color
		"G_FooterText"				"127 110 135 255" // Footer text color
		"G_DimmFooterText"			"127 110 135 120" // Dimm Footer text color
		...
		"G_MainMenuPanel"			"46 41 51 255" // Main Menu panel color
		"G_MainMenuButton"			"214 171 228 255" // Main Menu button color
		"G_MainMenuButtonHover"		"133 94 170 255" // Main Menu hovered button color
		"G_MainMenuButtonFg"		"31 22 38 255" // Main Menu button text color
		...
		"G_BackpackItemBg"			"79 3 107 0" // Backpack item bg color
		"G_LoadoutItemBg"			"44 31 39 255" // Loadout item bg color
		"G_MenuBg"					"53 42 56 255" // Menu bg color
		"G_MenuText"				"127 110 135 255" // Menu text color
		"G_InputText"				"49 3 57 255" // Input text color
		"G_DimmInputText"			"49 3 57 100" // Dimm Input text color
		"G_DimmMenuText"			"127 110 135 120" // Dimm Menu text color
		"G_ItemDescriptionPanelBg"	"48 34 43 255" // Item description panel bg
		"G_ButtonBg"				"42 31 47 255" // Button bg color
		"G_ButtonText"				"205 167 211 255" // Button text color
		"G_ButtonHoverBg"			"107 51 156 255" // Button hover bg color
		"G_ButtonHoverText"			"255 255 255 255" // Button hover text color
		"G_ButtonSelectedBg"		"73 32 94 255" // Button selected bg color
		"G_ButtonSelectedText"		"221 178 249 255" // Button selected text color
		...
		"G_MenuShader"				"16 9 24 122" // Menu shader color
		"G_XPBar"					"78 54 96 255" // XP Bar color
		"G_ItemEffectMeterLineColor"	"120 120 120 130"
		"G_MvmLobbyPanelBg"			"40 40 40 255"
		"G_MvmLobbyPanelText"		"220 220 220 255"
		
		// Crosshairs
		"G_Crosshair1Color"		"107 0 182 255" // Crosshair1 color
		"G_Crosshair2Color"		"255 255 255 255" // Crosshair2 color
		"G_Crosshair3Color"		"182 0 255 255" // Crosshair3 color
		...
		"TFOrange"			"16 5 66 255" // Highlight color
	...
	BaseSettings
	{
		...
		Slider.NobColor				"16 5 66 255" // Highlight color
		Slider.TextColor			"127 110 135 255" // Menu text color
		Slider.TrackColor			"127 110 135 255" // Menu text color
		Slider.DisabledTextColor1	"127 110 135 120" // Dimm Menu text color
		Slider.DisabledTextColor2	"127 110 135 120" // Dimm Menu text color
